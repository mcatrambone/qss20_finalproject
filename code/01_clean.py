...
01_clean.py
-----------
Select analytic variables, coerce dtypes, construct derived measures,
filter implausible values, and produce the clean analytic dataset.

Input:
    merged_ahrf.csv     -- output of 00_pullandmerge.py

Output:
    analytic_ahrf.csv   -- clean, analysis-ready county-level dataset
"""
